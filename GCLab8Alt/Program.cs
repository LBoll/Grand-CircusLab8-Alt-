...
namespace LabAlt8
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            items.Add("sour apple", 3.99);
            items.Add("pineapple", 5.99);
            ...
            Console.WriteLine("\nThank you for shopping at Santas Soda Shop!\n");
        }
        ...
        private static void Sodas(ArrayList foodPrices, ArrayList foodNames, Dictionary<string, double> items)
        {
            ...
            while (addMoreItems)
            {
                ...
                {
                    Console.WriteLine($"|{count}|{food.Key,-16}|${food.Value}");
                    count++;
                }
                Console.WriteLine("*======*======*======*======*======*======*======*======*");
                ...
                if (items.ContainsKey(input)) //If the users input matches the options in the shop
                {
                    ...
                    Console.WriteLine($"You've put {input} soda in your sleigh which is ${items[input]}! Wow! That's a low price!");
                }
                else if (input == "1" || input == "2" || input == "3" || input == "4" || input == "5" || input == "6" || input == "7" || input == "8" || input == "9")
                {
                    ...
                    Console.WriteLine($"\nYou've put {input} soda in your sleigh which is ${items[input]}! Wow! What a steal!\n");
                }
                else
                {
        ...
        {
            Console.Write("The total price of your cart is: ");
            double result = 0;
        ...
        private static bool Continue() //If the user would like to continue or not
        {
            ...
            while (valid)
            {
                ...
                {
                    Console.Write("Please make sure you stick to a valid answer! (y/n) ");
                }
            }
            return repeat;
        }
